...
INSERT IGNORE INTO `xxl_job_user` (`username`, `password`, `role`, `permission`) VALUES ('admin', 'e10adc3949ba59abbe56e057f20f883e', 1, NULL);
INSERT IGNORE INTO `xxl_job_group` (`app_name`, `title`, `address_type`, `address_list`, `update_time`) VALUES ('recommend-service', '推荐服务', 0, NULL, NOW());
