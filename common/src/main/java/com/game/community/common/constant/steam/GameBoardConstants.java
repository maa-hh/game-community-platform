...
public final class GameBoardConstants {
    ...
    public static final Set<String> DISCOVER_BOARDS = Set.of(ALL, HOT, NEW, FREE, DISCOUNT);
    public static final Set<String> CHART_BOARDS = Set.of(HOT, NEW, FREE, DISCOUNT);
